package com.uniovi.sdi_2122_108_spring;

import com.uniovi.sdi_2122_108_spring.pageobjects.*;
...
class Sdi2122108SpringApplicationTests {
    ...
    static String Geckodriver = "C:\\Users\\UO275874\\Desktop\\PL-SDI-Sesión5-material\\PL-SDI-Sesión5-material";
...
//Común a Windows y a MACOSX
    ...
    public void PR10() {
        //Vamos al formulario de logueo.
        PO_HomeView.clickOption(driver, "login", "class", "btn btn-primary");
        //Rellenamos el formulario con un dni invalido
        PO_LoginView.fillLoginForm(driver, "999999aaa", "123456");
        //Comprobamos que nos vuelve a salir el texto de identificación
    ...
    public void PR11() {
        ...
        //Llevamos a cabo la desconexión y comoprobamos que ahora nos sale el texto "Identifícate"
        PO_HomeView.clickOption(driver, "logout", "class", "btn btn-primary");
        String checkText2 = PO_HomeView.getP().getString("login.message", PO_Properties.getSPANISH());
    ...
    public void PR12() {
        ...
        PO_PrivateView.clickAndCheck(driver, "free", "//tbody/tr", 4);

        List<WebElement> result = PO_View.checkElementBy(driver, "text", "99999993D" );
        ...
        PO_PrivateView.disconnect(driver, "signup.message");
    }
...
//P14. Esta prueba podría encapsularse mejor ...
    ...
    public void PR14() {
         ...
         PO_PrivateView.clickAndCheck(driver, "free", "//a[contains(@href, 'mark/add')]", 0);
        ...
        PO_PrivateView.clickAndCheck(driver, "free", "//a[contains(@class, 'page-link')]", 3);
    ...
    public void PR15() {
        ...
        PO_PrivateView.clickAndCheck(driver, "free", "/li[contains(@id, 'marks-menu')]/a", 0);

        //Pinchamos en la opción de lista de notas.
        PO_PrivateView.clickAndCheck(driver, "free", "//a[contains(@href, 'mark/list')]", 0);
        ...
        PO_PrivateView.clickAndCheck(driver, "free", "/td[contains(text(), 'Nota Nueva 1')]/following-sibling::*/a[contains(@href, 'mark/delete')]", 0);
